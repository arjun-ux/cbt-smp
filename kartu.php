<div class="content-wrapper bg-light">
    <style>
        .Slim-header {
            background: linear-gradient(135deg, #FF512F, #DD2476); /* Orange-Red Printing Energy */
            border-radius: 0 0 30px 30px;
            padding-top: 3.5rem !important;
            padding-bottom: 5rem !important;
            position: relative;
            box-shadow: 0 10px 30px rgba(221, 36, 118, 0.15);
            z-index: 1;
        }
        .my-shadow {
        ...
        .form-control-premium:focus {
            border-color: #DD2476;
            box-shadow: 0 0 0 0.2rem rgba(221, 36, 118, 0.1);
        }
        .btn-gradient-red {
    ...
    <section class="content-header Slim-header pt-5 pb-5 mb-n5">
        <div class="container-fluid px-md-4">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
                <div class="text-center text-md-left mb-4 mb-md-0">
                    <h1 class="text-white font-weight-bold mb-1" style="font-family: 'Poppins', sans-serif; text-shadow: 0 2px 4px rgba(0,0,0,0.2);">
                        <i class="far fa-id-card mr-2"></i> <?= $judul ?>
                    </h1>
                    <p class="text-white-50 mb-0">Pengaturan tata letak dan cetak kartu identitas peserta</p>
                </div>
                <div class="d-flex gap-2 flex-wrap justify-content-center align-items-center">
                    <a href="<?= base_url('cbtcetak') ?>" class="btn btn-light rounded-pill px-4 shadow-sm font-weight-bold text-dark">
                        <i class="fas fa-arrow-left mr-2 text-danger"></i> KEMBALI
                    </a>
                    <button class="btn btn-white rounded-pill px-4 shadow-sm font-weight-bold mt-2 mt-md-0 ml-md-2" onclick="submitKartu()">
                        <i class="fas fa-save mr-2 text-primary"></i> SIMPAN SETTING
                    </button>
                    <button class="btn btn-gradient-red rounded-pill px-4 shadow-sm font-weight-bold mt-2 mt-md-0 ml-md-2" id="btn-print-top" onclick="$('#btn-print').click()">
    ...
    <section class="content pb-5 content-overlap" style="margin-top: -50px; position: relative; z-index: 2;">
        <div class="container-fluid px-md-4">
            <div class="row">
                <div class="col-md-5">
                    <div class="card my-shadow mb-4">
                        <div class="card-header bg-white border-0 pt-4 px-4 pb-0">
                            <h5 class="card-title font-weight-bold text-dark m-0"><i class="fas fa-edit mr-2 text-primary"></i> Konfigurasi Header</h5>
                        </div>
                        <div class="card-body p-4">
                             <?= form_open('', array('id' => 'set-kartu')) ?>
                            <div class="form-group mb-3">
                                <label class="small font-weight-bold text-muted text-uppercase mb-1">Header Baris 1</label>
                                <textarea id="header-1" class="form-control form-control-premium" name="header_1" rows="2"
                                          placeholder="Contoh: KARTU PESERTA UJIAN"
                                          required><?= isset($kartu->header_1) ? $kartu->header_1 : '' ?></textarea>
                            </div>
                            <div class="form-group mb-3">
                                <label class="small font-weight-bold text-muted text-uppercase mb-1">Header Baris 2</label>
                                <textarea id="header-2" class="form-control form-control-premium font-weight-bold" name="header_2" rows="2"
                                          placeholder="Contoh: NAMA SEKOLAH ANDA"
                                          required><?= isset($kartu->header_2) ? $kartu->header_2 : '' ?></textarea>
                            </div>
                            <div class="form-group mb-3">
                                <label class="small font-weight-bold text-muted text-uppercase mb-1">Header Baris 3</label>
                                <textarea id="header-3" class="form-control form-control-premium" name="header_3" rows="2"
                                          placeholder="Alamat Lengkap"
                                          required><?= isset($kartu->header_3) ? $kartu->header_3 : '' ?></textarea>
                            </div>
                            <div class="form-group mb-3">
                                <label class="small font-weight-bold text-muted text-uppercase mb-1">Header Baris 4</label>
                                <textarea id="header-4" class="form-control form-control-premium" name="header_4" rows="2"
                                          placeholder="Website / Email"
                                          required><?= isset($kartu->header_4) ? $kartu->header_4 : '' ?></textarea>
                            </div>
                            <div class="form-group mb-0">
                                <label class="small font-weight-bold text-muted text-uppercase mb-1">Titimangsa (Tempat, Tgl)</label>
                                <input id="input-tanggal" class="form-control form-control-premium" name="tanggal" placeholder="Contoh: Jakarta, 12 Juni 2024"
                ...
                <div class="col-md-7">
                    <div class="card my-shadow mb-4">
                        <div class="card-header bg-white border-0 pt-4 px-4 pb-0 d-flex align-items-center justify-content-between">
                            <h5 class="card-title font-weight-bold text-dark m-0"><i class="fas fa-search mr-2 text-primary"></i> Preview Kartu</h5>
                            <span class="badge badge-light border rounded-pill px-3 py-1 text-muted font-weight-bold small">Sesuai Ukuran Cetak</span>
                        </div>
                    ...
                    <div class="card my-shadow mb-4">
                        <div class="card-header bg-white border-0 pt-4 px-4 pb-0">
                            <h5 class="card-title font-weight-bold text-dark m-0"><i class="fas fa-print mr-2 text-primary"></i> Opsi Cetak</h5>
                        </div>
                        <div class="card-body p-4">
                            <div class="row align-items-end">
                                <div class="col-sm-8 mb-3 mb-sm-0">
                                    <label class="small font-weight-bold text-muted text-uppercase mb-1">Pilih Kelas / Rombel</label>
                                    <div class="input-group">
                                        ...
                                        echo form_dropdown(
                                            ...
                                            $kelas,
                                            null,
                                            'id="kelas" class="form-control select2"'
                                        ); ?>
                                    </div>
                                    <div class="input-group">
                                        <?php
                                        echo form_dropdown(
                                            ...
                                            $ruang,
                                            null,
                                            'id="ruang" class="form-control d-none select2"'
                                        ); ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <button class="btn btn-gradient-red rounded-pill px-4 shadow-sm w-100 font-weight-bold py-2" id="btn-print">
                                        <i class="fa fa-print mr-2"></i> CETAK KARTU
                                    </button>
                                </div>
                            </div>
                ...
                <div class="col-12">
                    <div class="card my-shadow mb-4">
                        <div class="card-header bg-white border-0 pt-4 px-4 pb-0 text-center">
                            <h5 class="card-title font-weight-bold text-dark w-100"><i class="fas fa-file-alt mr-2 text-primary"></i> Preview Halaman Cetak</h5>
                        </div>
                        <div class="card-body p-4">
